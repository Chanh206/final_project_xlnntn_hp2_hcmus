...
def ocr_local_image(local_path: str):
    ...
    prompt = (
            """Thực hiện OCR chữ viết/thư pháp/tiếng Hán trong ảnh này.
        Xử lý: thư pháp (nét cong/mỏng dày), viết tay (không đều), đánh máy, chữ Hán phồn/giản thể.

        Trích xuất từng từ/dòng chữ và vị trí bounding box của nó.
        Tọa độ bounding box theo thứ tự: [ymin, xmin, ymax, xmax] (chuẩn hóa 0-1000).
